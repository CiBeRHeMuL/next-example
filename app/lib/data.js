    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, postgres_1.sql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT * FROM revenue"], ["SELECT * FROM revenue"])))];
                case 1:
                    data = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    latestInvoices = data.rows.map(function (invoice) { return (__assign(__assign({}, invoice), { amount: (0, utils_1.formatCurrency)(invoice.amount) })); });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _e.trys.push([0, 2, , 3]);
                    invoiceCountPromise = (0, postgres_1.sql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["SELECT COUNT(*) FROM invoices"], ["SELECT COUNT(*) FROM invoices"])));
                    customerCountPromise = (0, postgres_1.sql)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["SELECT COUNT(*) FROM customers"], ["SELECT COUNT(*) FROM customers"])));
                    invoiceStatusPromise = (0, postgres_1.sql)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["SELECT\n         SUM(CASE WHEN status = 'paid' THEN amount ELSE 0 END) AS \"paid\",\n         SUM(CASE WHEN status = 'pending' THEN amount ELSE 0 END) AS \"pending\"\n         FROM invoices"], ["SELECT\n         SUM(CASE WHEN status = 'paid' THEN amount ELSE 0 END) AS \"paid\",\n         SUM(CASE WHEN status = 'pending' THEN amount ELSE 0 END) AS \"pending\"\n         FROM invoices"])));
                ...
                case 1:
                    ...
                    totalPaidInvoices = (0, utils_1.formatCurrency)((_c = data[2].rows[0].paid) !== null && _c !== void 0 ? _c : '0');
                    totalPendingInvoices = (0, utils_1.formatCurrency)((_d = data[2].rows[0].pending) !== null && _d !== void 0 ? _d : '0');
                    return [2 /*return*/, {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, postgres_1.sql)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["SELECT COUNT(*)\n    FROM invoices\n    JOIN customers ON invoices.customer_id = customers.id\n    WHERE\n      customers.name ILIKE ", " OR\n      customers.email ILIKE ", " OR\n      invoices.amount::text ILIKE ", " OR\n      invoices.date::text ILIKE ", " OR\n      invoices.status ILIKE ", "\n  "], ["SELECT COUNT(*)\n    FROM invoices\n    JOIN customers ON invoices.customer_id = customers.id\n    WHERE\n      customers.name ILIKE ", " OR\n      customers.email ILIKE ", " OR\n      invoices.amount::text ILIKE ", " OR\n      invoices.date::text ILIKE ", " OR\n      invoices.status ILIKE ", "\n  "])), "%".concat(query, "%"), "%".concat(query, "%"), "%".concat(query, "%"), "%".concat(query, "%"), "%".concat(query, "%"))];
                case 1:
                    count = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    customers = data.rows.map(function (customer) { return (__assign(__assign({}, customer), { total_pending: (0, utils_1.formatCurrency)(customer.total_pending), total_paid: (0, utils_1.formatCurrency)(customer.total_paid) })); });
                    return [2 /*return*/, customers];
                case 2:
                    err_2 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, postgres_1.sql)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["SELECT * FROM users WHERE email=", ""], ["SELECT * FROM users WHERE email=", ""])), email)];
                case 1:
                    user = _a.sent();
